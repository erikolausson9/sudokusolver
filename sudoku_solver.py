...
class SudokuImage:
    ...
    def sobel_convolution(self,input_array):
    ...
    def save_numpy_array(self, array, filepath):
    ...
    def gaussian_blur(self, input_array):
    ...
    def find_corners(self, input_array):
        """
        ...
        #Top left corner
        (best_row, best_col) = self.sub_image_search(input_array, 'top_left_corner_intermediate_13_13.npy', 0, mid_height, 0, mid_width)
        corner_positions.append(CornerPosition(best_row, best_col))

        #Top right corner
        (best_row, best_col) = self.sub_image_search(input_array, 'top_right_corner_intermediate_13_13.npy', 0, mid_height, mid_width, width)
        corner_positions.append(CornerPosition(best_row, best_col))

        #Lower right corner
        (best_row, best_col) = self.sub_image_search(input_array, 'lower_right_corner_intermediate_13_13.npy', mid_height, height, mid_width, width)
        corner_positions.append(CornerPosition(best_row, best_col))

        #Lower left corner
        (best_row, best_col) = self.sub_image_search(input_array, 'lower_left_corner_intermediate_13_13.npy', mid_height, height, 0, mid_width)
        corner_positions.append(CornerPosition(best_row, best_col))
   
        return corner_positions


    def sub_image_search(self, input_array, sub_image_path, start_row, end_row, start_col, end_col):
    ...
    def evaluate_corners(self, input_array, corner_position_list):
        ...
        if corner_level_count[2]==0:
            ...
            corner_position_list = self.rectify_corner(input_array, corner_position_list, corner_level_count[2], margin_of_error)
        else:
    ...
    def rectify_corner(self, input_array, corner_position_list, number_of_secure_corners, margin_of_error):
        """
        ...
        if number_of_secure_corners == 1:
            ...
            if corner_position_list[0].sideCount==2:
                ...
                (corner_position_list[2].row, corner_position_list[2].col)=\
                    self.sub_image_search(input_array, 'lower_right_corner_intermediate_13_13.npy', \
                ...
                (corner_position_list[3].row, corner_position_list[3].col) = \
                    self.sub_image_search(input_array, 'lower_left_corner_intermediate_13_13.npy', \
                        max(0, guess_row-margin_of_error), min(len(input_array),guess_row+margin_of_error), max(0, guess_col-margin_of_error), min(len(input_array[0]), guess_col+margin_of_error))
                ...
                (corner_position_list[0].row, corner_position_list[0].col) = \
                    self.sub_image_search(input_array, 'top_left_corner_intermediate_13_13.npy', \
                        max(0, guess_row-margin_of_error), min(len(input_array),guess_row+margin_of_error), max(0, guess_col-margin_of_error), min(len(input_array[0]), guess_col+margin_of_error))
            else:
                ...
                (corner_position_list[1].row, corner_position_list[1].col)=\
                    self.sub_image_search(input_array, 'top_right_corner_intermediate_13_13.npy', \
                        max(0, guess_row-margin_of_error), min(len(input_array),guess_row+margin_of_error), max(0, guess_col-margin_of_error), min(len(input_array[0]), guess_col+margin_of_error))
...
#This is as far as I got
    ...
    def save_number(self, number_array, directory, row, col, number=0):
        if number == 0:
    ...
    def identify_number(self, single_cell_input_array, true_numbers):
...
class SudokuMatrix:
    ...
    def trial_and_error(self):
        ...
        if firstGuess.check_solution() is False or pass_count==25:
